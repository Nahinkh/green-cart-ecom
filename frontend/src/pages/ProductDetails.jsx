...
const ProductDetails = () => {
  ...
  return (
    product && (
      <div className="mt-16">
        <p>
          <Link to="/">Home</Link> /<Link to="/all-product"> Products</Link> /
          <Link to={`/all-product/${product.category.toLowerCase()}`}>
            {" "}
            {product.category}
          </Link>{" "}
        ...
        <div className="flex flex-col md:flex-row gap-16 mt-4">
          ...
          <div className="text-sm w-full md:w-1/2">
            ...
            <div className="flex items-center mt-10 gap-4 text-base">
              ...
              className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-green-600 transition">
                Buy now
              </button>
            </div>
          </div>
